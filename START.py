...
try:
    ...
    if script_path.endswith('.zip'):
        print_section('SCRIPT IS RUNNING INSIDE OF A ZIP!!! PLEASE EXTRACT THE ZIP AND RUN THE SCRIPT FROM THE EXTRACTED FOLDER!!! (WATCH A TUTORIAL IF YOU DO NOT KNOW HOW)')
        print_section('SCRIPT IS RUNNING INSIDE OF A ZIP!!! PLEASE EXTRACT THE ZIP AND RUN THE SCRIPT FROM THE EXTRACTED FOLDER!!! (WATCH A TUTORIAL IF YOU DO NOT KNOW HOW)')
        print_section('SCRIPT IS RUNNING INSIDE OF A ZIP!!! PLEASE EXTRACT THE ZIP AND RUN THE SCRIPT FROM THE EXTRACTED FOLDER!!! (WATCH A TUTORIAL IF YOU DO NOT KNOW HOW)')
        print_section('SCRIPT IS RUNNING INSIDE OF A ZIP!!! PLEASE EXTRACT THE ZIP AND RUN THE SCRIPT FROM THE EXTRACTED FOLDER!!! (WATCH A TUTORIAL IF YOU DO NOT KNOW HOW)')
        print_section('SCRIPT IS RUNNING INSIDE OF A ZIP!!! PLEASE EXTRACT THE ZIP AND RUN THE SCRIPT FROM THE EXTRACTED FOLDER!!! (WATCH A TUTORIAL IF YOU DO NOT KNOW HOW)')
